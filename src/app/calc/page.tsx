  ...
  return (
    <AppShell>
      <div className="flex min-h-[60vh] flex-col items-center justify-center relative">
        {/* Dark gradient background to match signup aesthetic */}
        ...
        <div className="w-full max-w-6xl space-y-6 relative z-10">
          ...
          <section className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="inline-flex rounded-full border border-white/10 bg-black/20 p-1 text-xs sm:text-sm">
              <button
                type="button"
      ...
      {/* FAQs Tab */}
      {activeTab === "faqs" && (
        <section className="rounded-2xl border border-white/10 bg-black/40 p-8 shadow-xl space-y-6">
      ...
      {/* Dashboard Tab */}
      {activeTab === "dashboard" && (
        <section className="rounded-2xl border border-white/10 bg-black/40 p-8 shadow-xl space-y-4">
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
            Dashboard coming soon
          </h2>
          <p className="text-sm text-white/70">
