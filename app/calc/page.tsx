    ...
    <div className="space-y-6">
      ...
      <section className="space-y-2 text-center">
        <h1 className="text-3xl font-bold tracking-tight text-brand-text sm:text-4xl">
          UK Salary Calculator {TAX_YEAR} – Instant Take-Home Pay
        </h1>
        <p className="text-sm text-brand-textMuted">
          Calculate your UK take-home pay after tax, National Insurance, pension and student loan deductions for the {TAX_YEAR} tax year.
        </p>
      </section>
        ...
        <section className="rounded-3xl border border-brand-border/60 bg-brand-surface/80 p-8 shadow-soft-xl backdrop-blur space-y-6">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-brand-textMuted">
                Enter your gross income, tax code, pension contributions and student loan plan. The calculator uses official {TAX_YEAR} UK PAYE and National Insurance rates to compute your take-home pay. It shows a breakdown of tax, NI, pension and student loan deductions.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-brand-textMuted">
                All calculations use the {TAX_YEAR} UK tax year rates, including personal allowance, income tax bands, National Insurance thresholds and student loan repayment rates.
              </p>
            </div>
                ...
                mainEntity: [
                  {
                    ...
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: `Enter your gross income, tax code, pension contributions and student loan plan. The calculator uses official ${TAX_YEAR} UK PAYE and National Insurance rates to compute your take-home pay. It shows a breakdown of tax, NI, pension and student loan deductions.`,
                    },
                  },
                  {
                    "@type": "Question",
                    ...
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: `All calculations use the ${TAX_YEAR} UK tax year rates, including personal allowance, income tax bands, National Insurance thresholds and student loan repayment rates.`,
                    },
                  },
                  {
                    "@type": "Question",
                  ...
                  },
                  {
                    ...
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: `Yes. The calculator supports Plan 1, Plan 2, Plan 4, Plan 5 and Postgraduate loan repayments, using the correct thresholds and rates for the ${TAX_YEAR} tax year.`,
                    },
                  },
                  {
                    "@type": "Question",
